...
export function Sidebar({
  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-r border-[#222] bg-black">
      <div className="flex h-16 items-center gap-2 border-b border-[#222] px-6">
        ...
        <Link href="/dashboard" className="text-[15px] font-semibold text-white">
          Jobify
        </Link>
      </div>
      ...
      <div ref={popoverRef} className="relative border-t border-[#222]">
        {/* Popover */}
        {open && (
